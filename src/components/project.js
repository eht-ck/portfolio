...
const ProjectCard = ({ title, techStack, date, description }) => {
  return (
    <div className=" sm: w-100% md:w-1/3 p-4 mb-4  mr-1 ml-1 rounded-lg overflow-hidden shadow-lg bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 text-white hover:shadow-xl transition duration-300 border border-purple-600">
